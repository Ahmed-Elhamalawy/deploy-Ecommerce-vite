...
const Fashion1 = () => {
  ...
  const categories = [
    { id: 1, name: "men's clothing", label: "Men" },
    { id: 2, name: "women's clothing", label: "Women" },
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 1.5 }} // Transition properties
    >
      <div data-aos="fade-in">
        ...
        <div className="grid grid-cols-1 gap-y-10 md:grid-cols-2 gap-x-10 mx-6  lg:mx-20  my-24">
          ...
          >
            ...
            <span className="flex flex-col items-start justify-center absolute bottom-12 right-12 gap-1">
              ...
              <h1 className="lg:text-3xl font-bold text-2xl">New Collection</h1>
              <h1>Shop Now</h1>
            </span>
          </div>
          <div
        ...
        <section>
          <div className="flex flex-col grid-cols-1 items-center justify-center gap-8">
            ...
            <span className="flex items-start justify-center gap-5 px-5  ">
              {categories.map((category) => (
                <span
                  key={category.id}
                  onClick={() => setSelectedCategory(category.name)}
                  className={`text-[20px]  font-semibold  capitalize  cursor-pointer hover:text-red transition-colors ${
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 px-24 my-20">
          <div className="mb-10 relative flex items-center px-4">
            <div className="max-md:after:hidden w-full after:h-3/4 after:w-px after:bg-black after:bg-opacity-20 after:right-0 after:absolute  flex flex-col justify-center items-center gap-3 p-2">
          ...
          <div className="mb-10 relative flex items-center px-4 ">
            <div className="max-md:after:hidden  after:h-3/4 after:w-px after:bg-black after:bg-opacity-20 after:right-0 after:absolute w-full flex flex-col justify-center items-center gap-3 p-2">
              <GiCash className="size-12 font-light text-light text-opacity-40" />
              <h3 className="text-xl font-bold ">30 Day Return</h3>
              <p className="text-center text-base font-semibold text-black text-opacity-70">
                If you are going to use of Lorem, you need to be sure there
                anything
              </p>
